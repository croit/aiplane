...
use gateway_core::server::db::automatic_routes::{self, AutomaticRoute, AutomaticRouteCandidate};
use gateway_core::server::db::limits::ManagedBy;
...
async fn request(state: gateway::rama_server::RamaState) -> rama::http::Response {

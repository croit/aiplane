...
pools-field-allowed-groups-hint = Группы AIplane, которым разрешено видеть и использовать модели этого пула. Ничего не выбрано = все. Админы всегда имеют доступ. Управление группами в Admin → Группы.

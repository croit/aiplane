...
settings-s-content_guard = Проверка содержимого
settings-s-content_guard-blurb = Проверяет содержимое перед отправкой выбранной модели.
settings-f-content_guard-enabled = Включить проверку содержимого
settings-f-content_guard-enabled-help = Проверяет только область соответствия, которую не покрывает пул выбранной модели.
settings-f-content_guard-model = Модель проверки
settings-f-content_guard-model-help = Модель System One для решений GDPR и NDA.
settings-content-guard-model-warning = Эта модель System One не соответствует требованиям: { $requirements }. Отправленное ей содержимое может покинуть соответствующий контур защиты.
content-guard-confirm-heading = Защита содержимого
content-guard-confirm-question = Это содержимое определено как защищённое. Всё равно отправить его выбранной модели?
content-guard-confirm-approve = Всё равно отправить
content-guard-confirm-deny = Не отправлять
settings-f-content_guard-mode = Режим
settings-f-content_guard-mode-help = Наблюдение журналирует решения; применение выполняет выбранное действие.
settings-f-content_guard-mode-opt-monitor = Наблюдение
settings-f-content_guard-mode-opt-enforce = Применение
settings-f-content_guard-gdpr_action = Действие GDPR
settings-f-content_guard-gdpr_action-help = Действие при отправке персональных данных в пул без GDPR.
settings-f-content_guard-nda_action = Действие NDA
settings-f-content_guard-nda_action-help = Действие при отправке конфиденциального содержимого в пул без NDA.
settings-f-content_guard-gdpr_action-opt-allow = Разрешить
settings-f-content_guard-gdpr_action-opt-confirm = Запросить подтверждение
settings-f-content_guard-gdpr_action-opt-deny = Отклонить
settings-f-content_guard-nda_action-opt-allow = Разрешить
settings-f-content_guard-nda_action-opt-confirm = Запросить подтверждение
settings-f-content_guard-nda_action-opt-deny = Отклонить

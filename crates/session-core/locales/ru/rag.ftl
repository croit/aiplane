...
rag-hint-allowed-groups = Группы AIplane, которым разрешено просматривать и искать в этой коллекции. Ничего не выбрано = все, у кого есть RAG-инструменты. Админы всегда имеют доступ.

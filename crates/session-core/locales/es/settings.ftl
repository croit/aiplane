...
settings-s-content_guard = Control de contenido
settings-s-content_guard-blurb = Comprueba el contenido antes de que lo reciba el modelo seleccionado.

settings-f-content_guard-enabled = Activar control de contenido
settings-f-content_guard-enabled-help = Comprueba solo el área de cumplimiento que no cubre el pool del modelo seleccionado.
settings-f-content_guard-model = Modelo de control
settings-f-content_guard-model-help = Modelo System One usado para decisiones GDPR y NDA.
settings-content-guard-model-warning = Este modelo System One no cumple con: { $requirements }. El contenido enviado puede salir del perímetro de protección correspondiente.
content-guard-confirm-heading = Protección de contenido
content-guard-confirm-question = Este contenido se identificó como protegido. ¿Desea enviarlo igualmente al modelo seleccionado?
content-guard-confirm-approve = Enviar de todos modos
content-guard-confirm-deny = No enviar
settings-f-content_guard-mode = Modo
settings-f-content_guard-mode-help = Supervisar registra las decisiones en el registro; aplicar ejecuta la acción elegida.
settings-f-content_guard-mode-opt-monitor = Supervisar
settings-f-content_guard-mode-opt-enforce = Aplicar
settings-f-content_guard-gdpr_action = Acción GDPR
settings-f-content_guard-gdpr_action-help = Acción si datos personales se enviarían a un pool no conforme al GDPR.
settings-f-content_guard-nda_action = Acción NDA
settings-f-content_guard-nda_action-help = Acción si contenido confidencial se enviaría a un pool sin cobertura NDA.
settings-f-content_guard-gdpr_action-opt-allow = Permitir
settings-f-content_guard-gdpr_action-opt-confirm = Pedir confirmación
settings-f-content_guard-gdpr_action-opt-deny = Denegar
settings-f-content_guard-nda_action-opt-allow = Permitir
settings-f-content_guard-nda_action-opt-confirm = Pedir confirmación
settings-f-content_guard-nda_action-opt-deny = Denegar

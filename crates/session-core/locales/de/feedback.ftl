...
feedback-voice-button-title = Tippen, das Problem beschreiben, erneut tippen — wir füllen die Felder unten aus
...
feedback-business-label = Geschäftlicher Nutzen
...
feedback-shot-status-capturing = Wird erfasst…
...
feedback-confirm-public-p1-suffix = Issue-Tracker. Jeder kann es lesen.
feedback-confirm-private-p2-prefix = Bitte stelle sicher, dass dein Screenshot und die übermittelten Daten
feedback-confirm-private-p2-strong = keine persönlichen oder privaten Informationen
feedback-confirm-private-p2-suffix = enthalten (Namen, E-Mails, Tokens, Kundendaten, …).
feedback-confirm-cancel-button = Nein, ich möchte bearbeiten

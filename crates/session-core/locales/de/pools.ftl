...
pools-field-allowed-groups-hint = Kommagetrennte AIplane-Gruppen, die die Modelle dieses Pools sehen + nutzen dürfen. Leer = alle. Admins haben immer Zugriff. Gruppen unter Admin → Gruppen verwalten.

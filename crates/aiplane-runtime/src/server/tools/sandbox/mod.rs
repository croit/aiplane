...
use aiplane_core::server::config::SandboxConfig;
use aiplane_features::server::chat_attachments::{self, AttachmentRef};
use aiplane_features::server::file_refs;
...
mod tests {
    ...
    fn dead_s3() -> std::sync::Arc<aiplane_core::server::config::S3Config> {
        std::sync::Arc::new(aiplane_core::server::config::S3Config {

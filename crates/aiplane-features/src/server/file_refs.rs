...
use aiplane_core::server::db::documents::{self, Document, DocumentFormat, DocumentVersion};
...
mod tests {
    use super::*;
    use aiplane_core::server::db::documents::VersionAuthor;
    ...
    fn document_filenames_slug_the_title() {
        ...
        assert_eq!(file_name_of(&d), "croit-aiplane.json");

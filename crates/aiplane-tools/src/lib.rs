...
//! the [`Tool`](aiplane_runtime::server::tools::Tool) trait itself,
...
//! sandbox client — stays in `aiplane-core`, because `AppState` holds those or
...
//!
//! This crate sits above `aiplane-core` and beside `aiplane-api`: only the

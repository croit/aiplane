...
use aiplane_core::server::db::{self, rag as rag_db, rag_documents as docs_db};
...
use aiplane_features::server::rag::worker::{Indexer, IndexerConfig};
...
async fn indexed_store() -> (db::Pool, aiplane_core::server::db::Pool) {
